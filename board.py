...
class GoBoard(object):
    ...
    def getscore(self):
        # evaluate the score using our evaluation funciton     
        INFINITY = 100000
    ...
    def getPosScore(self,move): 
        # get the current position score
    ...
    def getBestmove(self): 
        # find all legal moves and sort them by the score
        legalmoves = self.get_empty_points()
        return sorted(legalmoves,key = self.getPosScore,reverse = True)
